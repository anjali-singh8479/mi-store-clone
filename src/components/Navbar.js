...
function Navbar({logo}) {
  const search = (
    <svg xmlns="http://www.w3.org/2000/svg" height="38" width="38" fill="black">
  ...
  return (
    <>
      <div className="nav">
        <div className="logo">
          <a  className="navlinks " href="/"><img src={logo}></img></a>
          ...
          <a className="navlinks" href="/laphrefps">
            Laptops
          </a>
