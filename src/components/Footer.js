   ...
   <div className='footer-wrap'>
    ...
    <div className='prefooter2'>
       ...
       <div>
            ...
            <p>Get updated on sales specials an dmore</p>
        </div>
        <div className="input">
            <input type="email" placeholder="mistore@gmail.com"></input>
            <button>></button>
        </div>
       </div>
       <div>
       <div>
        ...
        <div className='socials'>
           {youtubeIcon} {instagramIcon}{twitterIcon}{facebookIcon}
        </div>
       </div> */}
        <div>
            <h5>LET'S STAY IN TOUCH</h5>
            <span>Get updated on sales specials an dmore</span>
        </div>
       <div className='input'>
        
       <input type="email" placeholder="mistore@gmail.com"></input>
        <span>Thanks You're on our email for special Offers</span>
       </div>
    ...
    <div className='footer'>
           ...
           <div className='chat'>
            <h5>chat with our  virtual AI Bot-Now in  हिन्दी/English</h5>
       ...
       <div className='footer-end'> Copyright © 2010 - 2021 Xiaomi. All Rights Reserved</div>
